...
\end{lstlisting}
			...
			\item $NaCl$ 
				\begin{figure}[!h]
					\includegraphics[width=8cm]{{Material/NaCl}}
...
\end{lstlisting}	
			...
			\item $SrTiO_3$
				\begin{figure}[!h]
					\includegraphics[width=8cm]{{Material/SrTiO3}}
...
\end{lstlisting}	
			...
			\item $2H MoS_2$
				\begin{figure}[!h]
					\includegraphics[width=8cm]{{Material/MoS2-2H}}
					\caption{MoS2-2H}
					\label{fig:mos22h}
				\end{figure}
...
\end{lstlisting}			
	...
	\begin{enumerate}[label=(\alph*)]
		...
		The above equation can be re-align into matrix form :
		\begin{equation}
		\begin{bmatrix}
