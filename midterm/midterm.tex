...
\begin{enumerate}	
	...
	\item Car-Parrinelo EOM
		...
		\begin{align}
				L = \sum_{i} \frac{1}{2} \mu \int |\dot{\phi_i}(r)|^2 dr + \sum_{I} \frac{1}{2} M_I \dot{R_I}^2 - E \left[{\phi_i},{R_i}\right] - \sum_{ij} \Lambda_{ij} \left( \int \phi_i(r) \phi_j(r) dr - \delta_{ij} \right)
		\end{align} 
