...
tit.append("MnO-AFII Mn spin-up")
paths.append("MnO.1.d.dat")
tit.append("MnO-AFII Mn spin-down")
...
#plt.grid()
plt.savefig('MnO-AFII_Mn.png',format='png',transparent=True,dpi=100)
plt.show()
