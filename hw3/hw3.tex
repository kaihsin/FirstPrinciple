...
\begin{enumerate}	
	...
	the structure of NiO in AF-II :
	\begin{figure}[!h]
		\centering
		\includegraphics[width=6cm]{{Material/q4/NiOAFII}.png}
		\caption{NiO-AFII lattice structure}
		\label{fig:NiOAFII}
	\end{figure}
	\begin{itemize}
		\item GGA 
			\begin{enumerate}[label=(\arabic*)]
				\item the band structure and total DOS
				\begin{figure}[!h]
					\centering
					\begin{minipage}{.5\textwidth}
						\centering
						\includegraphics[width=9cm]{{Material/q4/NiO-AFOII}.png}
					...
					\begin{minipage}{0.5\textwidth}
						\centering
						\includegraphics[width=9cm]{{Material/q4/NiO-totdos}.png}
						\caption{NiO-AFII density of state}
						\label{fig:NiOAFII-dos}
					\end{minipage}
				\end{figure}
				
				\item density of state of Ni
					\begin{figure}[!h]
						\centering
						\includegraphics[width=12cm]{{Material/q4/NiO-AFII_Nidos}.png}
						\caption{Ni in NiO density of state}
						\label{fig:Ni-dos}
					\end{figure}
		...
		\begin{enumerate}[label=(\arabic*)]
			...
			\begin{figure}[!h]
				...
				\begin{minipage}{.5\textwidth}
					\centering
					\includegraphics[width=9cm]{{Material/q4/NiO-AFII+U}.png}
					\caption{NiO-AFII band-structure GGA+U}
					\label{fig:NiOAFII-band+U}
				\end{minipage}%
				\begin{minipage}{0.5\textwidth}
					\centering
					\includegraphics[width=9cm]{{Material/q4/NiO+u-totdos}.png}
					\caption{NiO-AFII density of state GGA+U}
					\label{fig:NiOAFII+u-dos}
				\end{minipage}
			\end{figure}
			...
			\item density of state of Ni
				\begin{figure}[!h]
					\centering
					\includegraphics[width=10cm]{{Material/q4/NiO-AFII_Nidos+u}.png}
					\caption{Ni in NiO density of state GGA+U}
					\label{fig:Ni-dos+u}
				\end{figure}
